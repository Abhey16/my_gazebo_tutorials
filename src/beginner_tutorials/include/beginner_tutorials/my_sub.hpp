/**
 * @file my_sub.hpp
 * @brief Header file for the SubscriberNode class implementing a ROS2 subscriber node
 * @details This class creates a ROS2 node that subscribes to custom string messages
 *          published on the "my_topic" topic
 */
...
private:
    ...
    rclcpp::Subscription<example_interfaces::msg::String>::SharedPtr subscriber_; ///< Subscriber for string messages
};